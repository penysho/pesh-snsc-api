...
//
//	mockgen -source=interact_provider_interface.go -destination=mock/interact_provider_mock.go -package=controller_mock
//
...
import (
	...
	interactor "github.com/penysho/pesh-snsc-api/post-app/usecase/interactor"
